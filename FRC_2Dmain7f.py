...
print("Phi_h Matrix", Phi_h.shape, ":")
print(Phi_h, "\n")

print("Phi_BC Matrix", Phi_bc.shape, ":")
print(Phi_bc, "\n")

print("varphi_p Column Vector", varphi_P.shape, ":")
print(varphi_P, "\n")

print("varphi_p_BC Column Vector", varphi_P_bc.shape, ":")
print(varphi_P_bc, "\n")
